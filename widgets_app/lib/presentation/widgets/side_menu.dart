...
class _SideMenuState extends State<SideMenu> {
  int navDrawerIndex = 0; // Es para saber cual widget esta seleccionada
  ...
  Widget build(BuildContext context) {
    ...
    return NavigationDrawer(
      ...
      onDestinationSelected: (value) {
        ...
        context.push(menuItem.link); // Navegamos desde el drawer
      ...
      // children: appMenuItems.map((e) => return e).toList(),
    );
  }
}
